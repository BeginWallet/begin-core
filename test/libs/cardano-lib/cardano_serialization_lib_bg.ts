/* tslint:disable */
// @ts-nocheck
import * as wasm from './cardano_serialization_lib.asm';
...
export class CostModel {
    ...
    */
    insert(key, value) {
        ...
        var len0 = WASM_VECTOR_LEN;
        _assertClass(value, BigInt);
        var ret = wasm.costmodel_insert(this.ptr, ptr0, len0, value.ptr);
    ...
    */
    get(key) {
        var ptr0 = passStringToWasm0(key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        var ret = wasm.costmodel_get(this.ptr, ptr0, len0);
        return ret === 0 ? undefined : BigInt.__wrap(ret);
    }
    /**
    * @returns {Strings}
    */
    keys() {
        var ret = wasm.costmodel_keys(this.ptr);
